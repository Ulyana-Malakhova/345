...
public class Program {
	...
	public static void main(String[] args) {
		...
		Screen screen = new Screen(0, "pixel", 0, 0);
		...
		while (ext == 0) {
			...
			System.out.println("5.Посчитать соотношение экрана к корпусу телефона");
			...
			if (d == 5){
				int r;
				Telephone.Screen_percentage phone = spisok.new Screen_percentage();
				spisok.ratio(phone);
				r = phone.percent;
				System.out.println("Соотношение экрана к корпусу телефона(%):"+r);
			}
			if (d == 6) {
